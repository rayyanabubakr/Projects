...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/nu-logo.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">Newton University - NU*</h4>
            <h4 class="text-dark">SCHOOL OF SCIENCE</h4>
        </div>
    </div>
    <div class="container-fluid mb-4 text-dark">
        <div class="program-info">
            <?php  
                ...
                $query = "select * from student_info inner join sessions on sessions.session=student_info.session where email = '$roll_no'";
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='1' and sc.email='$roll_no'";
                                ...
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        $result_query = "select * from class_result cr inner join student_courses cs on cr.subject_code = cs.subject_code and cr.roll_no=cs.roll_no where cr.subject_code='$subject' and cr.email='$roll_no'";
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='3' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        //$assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='4' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='5' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='6' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='7' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        //$assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='8' and sc.email='$roll_no'";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Semester - 8</span> </span></div></th>
                                    <th>CH</th>
                                    <th>%</th>
                                    <th>G.P</th>
                                    <th>Letter</th>
