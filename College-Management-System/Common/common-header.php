...
<html lang="en">
	<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="$baseUrl/../Images/nu-logo.png" type="image/x-icon">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        <img src="../images/nu-logo.png" class="logo-image" width="50" height="50">
        <h3 class="text-light text-uppercase ml-2">NEWTON UNIVERSITY</h3>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="../admission.php">ABOUT US<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
